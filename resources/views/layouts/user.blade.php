            ...
            <div class="row">
                ...
                <div class="col mt-3 mt-md-0 col-12 col-md-3 text-center text-md-left p-sm-0">
                    ...
                    <div class="rasel-copywright">
                        <p class="rasel-copywright-p font-weight-bold text-center">Made with&nbsp;<i class="fa fa-heartbeat rasel-copywright-p-icon"></i>&nbsp; By&nbsp;&nbsp;<a class="rasel-copywright-p-name" target="_blank" href="https://www.facebook.com/azharasel1">Ferdows</a></p>
                        <hr class="d-md-none">
                    </div>
                </div>
            </div>
